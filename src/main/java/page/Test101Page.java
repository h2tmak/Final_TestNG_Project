...
public class Test101Page {
	...
	String categoryType="Mak-y"+new Random().nextInt(999);
	String duplicateType="Mak-y";
	
	//
	@FindBy(how = How.XPATH,using="//*[@id=\"extra\"]/input[1]") WebElement CATEGORY_INSERT_BAR;
	@FindBy(how = How.XPATH,using="//*[@id=\"extra\"]/input[2]") WebElement ADD_CATEGORY_BUTTON;
	@FindBy(how = How.XPATH, using = "//select[option='None'] [3]") WebElement MONTH_LIST;
	@Test
